# Rindo Elements for Progressive Web Apps
...
the power of [Rindo JS](http://rindojs.web.app/).
...
Family PWA Elements were built primarily for developers using [Jigra](http://jigrajs.web.app/),
